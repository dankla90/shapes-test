(function (global, factory) {
    ...
    async patchContent(content, contentType, request) {
      ...
      try {
        ...
        */
        ...
        if (insertStmts && insertStmts.length > 1) return [400, "can not have multiple INSERT statements in a patch"];
  ...
  function queryForFirstResult(store, sparql) {
    return new Promise((resolve, reject) => {
      ...
      store.query(query, resolve, null, () => {
